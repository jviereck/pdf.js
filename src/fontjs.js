/**
  ...
  FontJS.js v2012.01.25
  (c) Mike "Pomax" Kamermans, 2012
  Licensed under MIT ("expat" flavour) license.
  Hosted on http://github.com/Pomax/FontJS.js

  This library adds FontJS objects to the general pool
  ...
  FontJS.js is compatible with all browsers that support
  ...
  IE9, Safari 5.1) at the time FontJS.js was released.

  FontJS.js will not work on IE8 or below due to the lack
  ...
  Issue tracker: https://github.com/Pomax/FontJS.js/issues
...
(function(window){
  ...
  if(!Object.defineProperty) {
    throw("FontJS.js requires Object.defineProperty, which this browser does not support.");
  }

  // 2) Do we have Canvas2D available?
  if(!document.createElement("canvas").getContext) {
    throw("FontJS.js requires <canvas> and the Canvas2D API, which this browser does not support.");
  }
  ...
  FontJS.prototype.fontFamily = "fjs" + (999999 * Math.random() | 0);

  // the font resource URL
  FontJS.prototype.url = "";

  // the font's format ('truetype' for TT-OTF or 'opentype' for CFF-OTF)
  FontJS.prototype.format = "";

  // the font's byte code
  FontJS.prototype.data = "";

  // custom font, implementing the letter 'A' as zero-width letter.
  FontJS.prototype.base64 = "AAEAAAAKAIAAAwAgT1MvMgAAAAAAAACsAAAAWGNtYXAA"+
  ...
  FontJS.prototype.systemfont = false;

  // internal indicator that the font is done loading
  FontJS.prototype.loaded = false;
   ...
   */
  FontJS.prototype.onload = function () {};

  /**
   * This function gets called when there is a problem
   * loading the font.
   */
  FontJS.prototype.onerror = function () {};

  // preassigned quad × quad context, for measurements
  FontJS.prototype.canvas = false;
  FontJS.prototype.context = false;
   ...
   */
  FontJS.prototype.validate = function (target, zero, mark, font, timeout) {
   ...
   */
  FontJS.prototype.ondownloaded = function () {
  ...
  FontJS.prototype.bootstrapValidation = function (printChar, timeout) {
    ...
    if (!document.defaultView.getComputedStyle) {
      ...
      error("Error: document.defaultView.getComputedStyle is not supported by this browser.\n" +
            "Consequently, FontJS.onload() cannot be trusted."); }
   ...
   */
  FontJS.prototype.processSystemFontJS = function () {
   ...
   */
  FontJS.prototype.loadFontJS = function () {
    var font = this;

    // System font?
    if(this.url.indexOf(".") === -1) {
      setTimeout(function(){
        font.processSystemFontJS();
      }, 10);
      return;
    }
  ...
  FontJS.prototype.styleNode = false;

  /**
   * Get the DOM node associated with this FontJS
   * object, for page-injection.
   */
  FontJS.prototype.toStyleNode = function () {
   ...
   * separately.
   */
  FontJS.prototype.measureText = function (textString, fontSize) {
    // error shortcut
    if (!this.loaded) {
   ...
   */
  FontJS.prototype.measureSegment = function(textSegment, fontSize, metrics) {
  ...
  /**
   * we want FontJS to do the same thing Image does when
   ...
   */
  Object.defineProperty(FontJS.prototype, "src", { set: function(url) { this.url=url; this.loadFontJS(); }});


  /**
   * Bind to global scope
   */
  window.FontJS = FontJS;
